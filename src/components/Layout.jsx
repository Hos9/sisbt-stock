    ...
    <div className="min-h-screen bg-surface-muted">
      ...
      >
        <div className="flex h-16 items-center gap-2 px-6 border-b border-white/10">
          <div className="flex h-8 w-20 items-center justify-center rounded-lg bg-signal text-white font-display font-bold text-sm">
            SISBT
          </div>
      ...
      <div className="lg:pl-64">
        ...
        <footer className="border-t border-surface-border py-6 text-center text-xs text-ink-700/60">
          Developed by <span className="font-bold">Hos9</span> for{" "}
          <span className="font-bold">SIS - Bank Town PoP</span>
        </footer>
      </div>
    </div>
  );
