      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="font-display text-xl font-bold text-white">NetStock</h1>
            <p className="text-sm text-white/50">ISP Stock &amp; Inventory Portal</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl bg-white p-6 shadow-card sm:p-8">
          ...
          <p className="mb-6 text-sm text-ink-700/60">Authorized personnel only.</p>
